# UGAHacks2026_whispering_witches

A magical battle-royale where a witch competes to restore a destroyed world by defeating goblins using spells from the Grimoire.

Whispering Witches 

By team: Garuda Coders
...
•	Blender for 3D game object modeling
•	Unity Engine to make the actual gaming layout
•	C#, Python to code our game.
